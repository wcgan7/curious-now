.PHONY: venv install dev-up dev-down migrate api test lint typecheck check sync-once sync-loop v2-sources v2-migrate v2-sync-sources v2-ingest v2-hydrate v2-retrieve v2-gate v2-fixtures v2-rank v2-test v2-lint v2-typecheck reader-install reader-dev reader-typecheck reader-build v2-check
