...
2. [`ARCHITECTURE.md`](ARCHITECTURE.md) — the lean runtime and data flow
3. [`PORTING.md`](PORTING.md) — what is retained from v1 and what is deliberately left behind
4. [`OPERATIONS.md`](OPERATIONS.md) — local commands, scheduled deployment, and cost controls
